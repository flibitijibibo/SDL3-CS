...
public static unsafe class SDL
{
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_AssertState SDL_ReportAssertion(ref SDL_AssertData data, ref char func, ref char file, int line); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetError(ref char fmt); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetPointerPropertyWithCleanup(uint props, ref char name, IntPtr value, /* SDL_CleanupPropertyCallback */ IntPtr cleanup, IntPtr userdata); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetPointerProperty(uint props, ref char name, IntPtr value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetStringProperty(uint props, ref char name, ref char value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetNumberProperty(uint props, ref char name, long value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetFloatProperty(uint props, ref char name, float value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetBooleanProperty(uint props, ref char name, bool value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_HasProperty(uint props, ref char name); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_PropertyType SDL_GetPropertyType(uint props, ref char name); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GetPointerProperty(uint props, ref char name, IntPtr default_value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GetStringProperty(uint props, ref char name, ref char default_value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern long SDL_GetNumberProperty(uint props, ref char name, long default_value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern float SDL_GetFloatProperty(uint props, ref char name, float default_value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_GetBooleanProperty(uint props, ref char name, bool default_value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_ClearProperty(uint props, ref char name); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_IOFromFile(ref char file, ref char mode); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern UIntPtr SDL_IOprintf(IntPtr context, ref char fmt); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_LoadFile_IO(IntPtr src, ref UIntPtr datasize, bool closeio); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_LoadFile(ref char file, ref UIntPtr datasize); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_LoadWAV(ref char path, ref SDL_AudioSpec spec, ref IntPtr audio_buf, ref uint audio_len); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_LoadBMP(ref char file); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SaveBMP_IO(ref SDL_Surface surface, IntPtr dst, bool closeio); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SaveBMP(ref SDL_Surface surface, ref char file); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetClipboardText(ref char text); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetPrimarySelectionText(ref char text); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GetClipboardData(ref char mime_type, ref UIntPtr size); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_HasClipboardData(ref char mime_type); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_CreateWindow(ref char title, int w, int h, ulong flags); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetWindowTitle(IntPtr window, ref char title); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_GL_LoadLibrary(ref char path); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GL_GetProcAddress(ref char proc); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_EGL_GetProcAddress(ref char proc); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_GL_UnloadLibrary();

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_GL_ExtensionSupported(ref char extension); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_ShowOpenFileDialog(/* SDL_DialogFileCallback */ IntPtr callback, IntPtr userdata, IntPtr window, ref SDL_DialogFileFilter filters, int nfilters, ref char default_location, bool allow_many); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_ShowSaveFileDialog(/* SDL_DialogFileCallback */ IntPtr callback, IntPtr userdata, IntPtr window, ref SDL_DialogFileFilter filters, int nfilters, ref char default_location); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_ShowOpenFolderDialog(/* SDL_DialogFileCallback */ IntPtr callback, IntPtr userdata, IntPtr window, ref char default_location, bool allow_many); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_GUIDToString(SDL_GUID guid, ref char pszGUID, int cbGUID); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_GUID SDL_StringToGUID(ref char pchGUID); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_AddGamepadMapping(ref char mapping); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_AddGamepadMappingsFromIO(IntPtr src, bool closeio);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_AddGamepadMappingsFromFile(ref char file); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetGamepadMapping(uint instance_id, ref char mapping); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_GamepadType SDL_GetGamepadTypeFromString(ref char str); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GetGamepadStringForType(SDL_GamepadType type);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_GamepadAxis SDL_GetGamepadAxisFromString(ref char str); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_GamepadButton SDL_GetGamepadButtonFromString(ref char str); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetScancodeName(SDL_Scancode scancode, ref char name); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GetScancodeName(SDL_Scancode scancode);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern SDL_Scancode SDL_GetScancodeFromName(ref char name); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GetKeyName(uint key);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern uint SDL_GetKeyFromName(ref char name); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GetPrefPath(ref char org, ref char app); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_CreateDirectory(ref char path); // WARN_UNKNOWN_POINTER_PARAMETER

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate int SDL_EnumerateDirectoryCallback(IntPtr userdata, IntPtr dirname, IntPtr fname);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_EnumerateDirectory(ref char path, /* SDL_EnumerateDirectoryCallback */ IntPtr callback, IntPtr userdata); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_RemovePath(ref char path); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_RenamePath(ref char oldpath, ref char newpath); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_CopyFile(ref char oldpath, ref char newpath); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_GetPathInfo(ref char path, ref SDL_PathInfo info); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GlobDirectory(ref char path, ref char pattern, uint flags, ref int count); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_CreateGPUDevice(uint format_flags, bool debug_mode, ref char name); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_SetGPUBufferName(IntPtr device, IntPtr buffer, ref char text); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_SetGPUTextureName(IntPtr device, IntPtr texture, ref char text); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_InsertGPUDebugLabel(IntPtr command_buffer, ref char text); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_PushGPUDebugGroup(IntPtr command_buffer, ref char name); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_hid_open(ushort vendor_id, ushort product_id, ref char serial_number); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_hid_open_path(ref char path); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_hid_get_manufacturer_string(IntPtr dev, ref char @string, UIntPtr maxlen); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_hid_get_product_string(IntPtr dev, ref char @string, UIntPtr maxlen); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_hid_get_serial_number_string(IntPtr dev, ref char @string, UIntPtr maxlen); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern int SDL_hid_get_indexed_string(IntPtr dev, int string_index, ref char @string, UIntPtr maxlen); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    const string SDL_HINT_ALLOW_ALT_TAB_WHILE_GRABBED = "SDL_ALLOW_ALT_TAB_WHILE_GRABBED";
    const string SDL_HINT_ANDROID_ALLOW_RECREATE_ACTIVITY = "SDL_ANDROID_ALLOW_RECREATE_ACTIVITY";
    ...
    const string SDL_HINT_APP_ID = "SDL_APP_ID";
    const string SDL_HINT_APP_NAME = "SDL_APP_NAME";
    const string SDL_HINT_APPLE_TV_CONTROLLER_UI_EVENTS = "SDL_APPLE_TV_CONTROLLER_UI_EVENTS";
    const string SDL_HINT_APPLE_TV_REMOTE_ALLOW_ROTATION = "SDL_APPLE_TV_REMOTE_ALLOW_ROTATION";
    const string SDL_HINT_AUDIO_ALSA_DEFAULT_DEVICE = "SDL_AUDIO_ALSA_DEFAULT_DEVICE";
    const string SDL_HINT_AUDIO_CATEGORY = "SDL_AUDIO_CATEGORY";
    const string SDL_HINT_AUDIO_CHANNELS = "SDL_AUDIO_CHANNELS";
    const string SDL_HINT_AUDIO_DEVICE_APP_ICON_NAME = "SDL_AUDIO_DEVICE_APP_ICON_NAME";
    const string SDL_HINT_AUDIO_DEVICE_SAMPLE_FRAMES = "SDL_AUDIO_DEVICE_SAMPLE_FRAMES";
    ...
    const string SDL_HINT_AUDIO_DISK_INPUT_FILE = "SDL_AUDIO_DISK_INPUT_FILE";
    const string SDL_HINT_AUDIO_DISK_OUTPUT_FILE = "SDL_AUDIO_DISK_OUTPUT_FILE";
    const string SDL_HINT_AUDIO_DISK_TIMESCALE = "SDL_AUDIO_DISK_TIMESCALE";
    const string SDL_HINT_AUDIO_DRIVER = "SDL_AUDIO_DRIVER";
    const string SDL_HINT_AUDIO_DUMMY_TIMESCALE = "SDL_AUDIO_DUMMY_TIMESCALE";
    const string SDL_HINT_AUDIO_FORMAT = "SDL_AUDIO_FORMAT";
    const string SDL_HINT_AUDIO_FREQUENCY = "SDL_AUDIO_FREQUENCY";
    ...
    const string SDL_HINT_CAMERA_DRIVER = "SDL_CAMERA_DRIVER";
    const string SDL_HINT_CPU_FEATURE_MASK = "SDL_CPU_FEATURE_MASK";
    const string SDL_HINT_JOYSTICK_DIRECTINPUT = "SDL_JOYSTICK_DIRECTINPUT";
    const string SDL_HINT_FILE_DIALOG_DRIVER = "SDL_FILE_DIALOG_DRIVER";
    ...
    const string SDL_HINT_EMSCRIPTEN_CANVAS_SELECTOR = "SDL_EMSCRIPTEN_CANVAS_SELECTOR";
    const string SDL_HINT_EMSCRIPTEN_KEYBOARD_ELEMENT = "SDL_EMSCRIPTEN_KEYBOARD_ELEMENT";
    const string SDL_HINT_ENABLE_SCREEN_KEYBOARD = "SDL_ENABLE_SCREEN_KEYBOARD";
    const string SDL_HINT_EVDEV_DEVICES = "SDL_EVDEV_DEVICES";
    const string SDL_HINT_EVENT_LOGGING = "SDL_EVENT_LOGGING";
    const string SDL_HINT_FORCE_RAISEWINDOW = "SDL_FORCE_RAISEWINDOW";
    ...
    const string SDL_HINT_GAMECONTROLLERCONFIG_FILE = "SDL_GAMECONTROLLERCONFIG_FILE";
    const string SDL_HINT_GAMECONTROLLERTYPE = "SDL_GAMECONTROLLERTYPE";
    const string SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES = "SDL_GAMECONTROLLER_IGNORE_DEVICES";
    const string SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT = "SDL_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT";
    const string SDL_HINT_GAMECONTROLLER_SENSOR_FUSION = "SDL_GAMECONTROLLER_SENSOR_FUSION";
    const string SDL_HINT_GDK_TEXTINPUT_DEFAULT_TEXT = "SDL_GDK_TEXTINPUT_DEFAULT_TEXT";
    const string SDL_HINT_GDK_TEXTINPUT_DESCRIPTION = "SDL_GDK_TEXTINPUT_DESCRIPTION";
    const string SDL_HINT_GDK_TEXTINPUT_MAX_LENGTH = "SDL_GDK_TEXTINPUT_MAX_LENGTH";
    const string SDL_HINT_GDK_TEXTINPUT_SCOPE = "SDL_GDK_TEXTINPUT_SCOPE";
    const string SDL_HINT_GDK_TEXTINPUT_TITLE = "SDL_GDK_TEXTINPUT_TITLE";
    const string SDL_HINT_HIDAPI_LIBUSB = "SDL_HIDAPI_LIBUSB";
    const string SDL_HINT_HIDAPI_LIBUSB_WHITELIST = "SDL_HIDAPI_LIBUSB_WHITELIST";
    const string SDL_HINT_HIDAPI_UDEV = "SDL_HIDAPI_UDEV";
    const string SDL_HINT_GPU_DRIVER = "SDL_GPU_DRIVER";
    const string SDL_HINT_HIDAPI_ENUMERATE_ONLY_CONTROLLERS = "SDL_HIDAPI_ENUMERATE_ONLY_CONTROLLERS";
    const string SDL_HINT_HIDAPI_IGNORE_DEVICES = "SDL_HIDAPI_IGNORE_DEVICES";
    const string SDL_HINT_IME_IMPLEMENTED_UI = "SDL_IME_IMPLEMENTED_UI";
    const string SDL_HINT_IOS_HIDE_HOME_INDICATOR = "SDL_IOS_HIDE_HOME_INDICATOR";
    const string SDL_HINT_JOYSTICK_ALLOW_BACKGROUND_EVENTS = "SDL_JOYSTICK_ALLOW_BACKGROUND_EVENTS";
    const string SDL_HINT_JOYSTICK_ARCADESTICK_DEVICES = "SDL_JOYSTICK_ARCADESTICK_DEVICES";
    const string SDL_HINT_JOYSTICK_ARCADESTICK_DEVICES_EXCLUDED = "SDL_JOYSTICK_ARCADESTICK_DEVICES_EXCLUDED";
    const string SDL_HINT_JOYSTICK_BLACKLIST_DEVICES = "SDL_JOYSTICK_BLACKLIST_DEVICES";
    const string SDL_HINT_JOYSTICK_BLACKLIST_DEVICES_EXCLUDED = "SDL_JOYSTICK_BLACKLIST_DEVICES_EXCLUDED";
    const string SDL_HINT_JOYSTICK_DEVICE = "SDL_JOYSTICK_DEVICE";
    const string SDL_HINT_JOYSTICK_FLIGHTSTICK_DEVICES = "SDL_JOYSTICK_FLIGHTSTICK_DEVICES";
    const string SDL_HINT_JOYSTICK_FLIGHTSTICK_DEVICES_EXCLUDED = "SDL_JOYSTICK_FLIGHTSTICK_DEVICES_EXCLUDED";
    const string SDL_HINT_JOYSTICK_GAMEINPUT = "SDL_JOYSTICK_GAMEINPUT";
    const string SDL_HINT_JOYSTICK_GAMECUBE_DEVICES = "SDL_JOYSTICK_GAMECUBE_DEVICES";
    const string SDL_HINT_JOYSTICK_GAMECUBE_DEVICES_EXCLUDED = "SDL_JOYSTICK_GAMECUBE_DEVICES_EXCLUDED";
    const string SDL_HINT_JOYSTICK_HIDAPI = "SDL_JOYSTICK_HIDAPI";
    const string SDL_HINT_JOYSTICK_HIDAPI_COMBINE_JOY_CONS = "SDL_JOYSTICK_HIDAPI_COMBINE_JOY_CONS";
    const string SDL_HINT_JOYSTICK_HIDAPI_GAMECUBE = "SDL_JOYSTICK_HIDAPI_GAMECUBE";
    const string SDL_HINT_JOYSTICK_HIDAPI_GAMECUBE_RUMBLE_BRAKE = "SDL_JOYSTICK_HIDAPI_GAMECUBE_RUMBLE_BRAKE";
    const string SDL_HINT_JOYSTICK_HIDAPI_JOY_CONS = "SDL_JOYSTICK_HIDAPI_JOY_CONS";
    const string SDL_HINT_JOYSTICK_HIDAPI_JOYCON_HOME_LED = "SDL_JOYSTICK_HIDAPI_JOYCON_HOME_LED";
    const string SDL_HINT_JOYSTICK_HIDAPI_LUNA = "SDL_JOYSTICK_HIDAPI_LUNA";
    const string SDL_HINT_JOYSTICK_HIDAPI_NINTENDO_CLASSIC = "SDL_JOYSTICK_HIDAPI_NINTENDO_CLASSIC";
    const string SDL_HINT_JOYSTICK_HIDAPI_PS3 = "SDL_JOYSTICK_HIDAPI_PS3";
    const string SDL_HINT_JOYSTICK_HIDAPI_PS3_SIXAXIS_DRIVER = "SDL_JOYSTICK_HIDAPI_PS3_SIXAXIS_DRIVER";
    const string SDL_HINT_JOYSTICK_HIDAPI_PS4 = "SDL_JOYSTICK_HIDAPI_PS4";
    const string SDL_HINT_JOYSTICK_HIDAPI_PS4_REPORT_INTERVAL = "SDL_JOYSTICK_HIDAPI_PS4_REPORT_INTERVAL";
    const string SDL_HINT_JOYSTICK_HIDAPI_PS4_RUMBLE = "SDL_JOYSTICK_HIDAPI_PS4_RUMBLE";
    const string SDL_HINT_JOYSTICK_HIDAPI_PS5 = "SDL_JOYSTICK_HIDAPI_PS5";
    const string SDL_HINT_JOYSTICK_HIDAPI_PS5_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_PS5_PLAYER_LED";
    const string SDL_HINT_JOYSTICK_HIDAPI_PS5_RUMBLE = "SDL_JOYSTICK_HIDAPI_PS5_RUMBLE";
    const string SDL_HINT_JOYSTICK_HIDAPI_SHIELD = "SDL_JOYSTICK_HIDAPI_SHIELD";
    ...
    const string SDL_HINT_JOYSTICK_HIDAPI_STEAMDECK = "SDL_JOYSTICK_HIDAPI_STEAMDECK";
    const string SDL_HINT_JOYSTICK_HIDAPI_SWITCH = "SDL_JOYSTICK_HIDAPI_SWITCH";
    const string SDL_HINT_JOYSTICK_HIDAPI_SWITCH_HOME_LED = "SDL_JOYSTICK_HIDAPI_SWITCH_HOME_LED";
    const string SDL_HINT_JOYSTICK_HIDAPI_SWITCH_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_SWITCH_PLAYER_LED";
    const string SDL_HINT_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS = "SDL_JOYSTICK_HIDAPI_VERTICAL_JOY_CONS";
    const string SDL_HINT_JOYSTICK_HIDAPI_WII = "SDL_JOYSTICK_HIDAPI_WII";
    const string SDL_HINT_JOYSTICK_HIDAPI_WII_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_WII_PLAYER_LED";
    const string SDL_HINT_JOYSTICK_HIDAPI_XBOX = "SDL_JOYSTICK_HIDAPI_XBOX";
    const string SDL_HINT_JOYSTICK_HIDAPI_XBOX_360 = "SDL_JOYSTICK_HIDAPI_XBOX_360";
    const string SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED = "SDL_JOYSTICK_HIDAPI_XBOX_360_PLAYER_LED";
    const string SDL_HINT_JOYSTICK_HIDAPI_XBOX_360_WIRELESS = "SDL_JOYSTICK_HIDAPI_XBOX_360_WIRELESS";
    const string SDL_HINT_JOYSTICK_HIDAPI_XBOX_ONE = "SDL_JOYSTICK_HIDAPI_XBOX_ONE";
    const string SDL_HINT_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED = "SDL_JOYSTICK_HIDAPI_XBOX_ONE_HOME_LED";
    const string SDL_HINT_JOYSTICK_IOKIT = "SDL_JOYSTICK_IOKIT";
    const string SDL_HINT_JOYSTICK_LINUX_CLASSIC = "SDL_JOYSTICK_LINUX_CLASSIC";
    const string SDL_HINT_JOYSTICK_LINUX_DEADZONES = "SDL_JOYSTICK_LINUX_DEADZONES";
    const string SDL_HINT_JOYSTICK_LINUX_DIGITAL_HATS = "SDL_JOYSTICK_LINUX_DIGITAL_HATS";
    const string SDL_HINT_JOYSTICK_LINUX_HAT_DEADZONES = "SDL_JOYSTICK_LINUX_HAT_DEADZONES";
    const string SDL_HINT_JOYSTICK_MFI = "SDL_JOYSTICK_MFI";
    const string SDL_HINT_JOYSTICK_RAWINPUT = "SDL_JOYSTICK_RAWINPUT";
    const string SDL_HINT_JOYSTICK_RAWINPUT_CORRELATE_XINPUT = "SDL_JOYSTICK_RAWINPUT_CORRELATE_XINPUT";
    const string SDL_HINT_JOYSTICK_ROG_CHAKRAM = "SDL_JOYSTICK_ROG_CHAKRAM";
    const string SDL_HINT_JOYSTICK_THREAD = "SDL_JOYSTICK_THREAD";
    const string SDL_HINT_JOYSTICK_THROTTLE_DEVICES = "SDL_JOYSTICK_THROTTLE_DEVICES";
    const string SDL_HINT_JOYSTICK_THROTTLE_DEVICES_EXCLUDED = "SDL_JOYSTICK_THROTTLE_DEVICES_EXCLUDED";
    const string SDL_HINT_JOYSTICK_WGI = "SDL_JOYSTICK_WGI";
    const string SDL_HINT_JOYSTICK_WHEEL_DEVICES = "SDL_JOYSTICK_WHEEL_DEVICES";
    const string SDL_HINT_JOYSTICK_WHEEL_DEVICES_EXCLUDED = "SDL_JOYSTICK_WHEEL_DEVICES_EXCLUDED";
    const string SDL_HINT_JOYSTICK_ZERO_CENTERED_DEVICES = "SDL_JOYSTICK_ZERO_CENTERED_DEVICES";
    const string SDL_HINT_KEYCODE_OPTIONS = "SDL_KEYCODE_OPTIONS";
    const string SDL_HINT_KMSDRM_DEVICE_INDEX = "SDL_KMSDRM_DEVICE_INDEX";
    const string SDL_HINT_KMSDRM_REQUIRE_DRM_MASTER = "SDL_KMSDRM_REQUIRE_DRM_MASTER";
    const string SDL_HINT_LOGGING = "SDL_LOGGING";
    const string SDL_HINT_MAC_BACKGROUND_APP = "SDL_MAC_BACKGROUND_APP";
    const string SDL_HINT_MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK = "SDL_MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK";
    const string SDL_HINT_MAC_OPENGL_ASYNC_DISPATCH = "SDL_MAC_OPENGL_ASYNC_DISPATCH";
    const string SDL_HINT_MAIN_CALLBACK_RATE = "SDL_MAIN_CALLBACK_RATE";
    const string SDL_HINT_MOUSE_AUTO_CAPTURE = "SDL_MOUSE_AUTO_CAPTURE";
    const string SDL_HINT_MOUSE_DOUBLE_CLICK_RADIUS = "SDL_MOUSE_DOUBLE_CLICK_RADIUS";
    const string SDL_HINT_MOUSE_DOUBLE_CLICK_TIME = "SDL_MOUSE_DOUBLE_CLICK_TIME";
    const string SDL_HINT_MOUSE_EMULATE_WARP_WITH_RELATIVE = "SDL_MOUSE_EMULATE_WARP_WITH_RELATIVE";
    ...
    const string SDL_HINT_MOUSE_RELATIVE_SPEED_SCALE = "SDL_MOUSE_RELATIVE_SPEED_SCALE";
    const string SDL_HINT_MOUSE_RELATIVE_SYSTEM_SCALE = "SDL_MOUSE_RELATIVE_SYSTEM_SCALE";
    const string SDL_HINT_MOUSE_RELATIVE_WARP_MOTION = "SDL_MOUSE_RELATIVE_WARP_MOTION";
    const string SDL_HINT_MOUSE_RELATIVE_CURSOR_VISIBLE = "SDL_MOUSE_RELATIVE_CURSOR_VISIBLE";
    const string SDL_HINT_MOUSE_RELATIVE_CLIP_INTERVAL = "SDL_MOUSE_RELATIVE_CLIP_INTERVAL";
    const string SDL_HINT_MOUSE_TOUCH_EVENTS = "SDL_MOUSE_TOUCH_EVENTS";
    const string SDL_HINT_MUTE_CONSOLE_KEYBOARD = "SDL_MUTE_CONSOLE_KEYBOARD";
    const string SDL_HINT_NO_SIGNAL_HANDLERS = "SDL_NO_SIGNAL_HANDLERS";
    const string SDL_HINT_OPENGL_LIBRARY = "SDL_OPENGL_LIBRARY";
    const string SDL_HINT_OPENGL_ES_DRIVER = "SDL_OPENGL_ES_DRIVER";
    const string SDL_HINT_ORIENTATIONS = "SDL_ORIENTATIONS";
    const string SDL_HINT_POLL_SENTINEL = "SDL_POLL_SENTINEL";
    const string SDL_HINT_PREFERRED_LOCALES = "SDL_PREFERRED_LOCALES";
    const string SDL_HINT_QUIT_ON_LAST_WINDOW_CLOSE = "SDL_QUIT_ON_LAST_WINDOW_CLOSE";
    const string SDL_HINT_RENDER_DIRECT3D_THREADSAFE = "SDL_RENDER_DIRECT3D_THREADSAFE";
    const string SDL_HINT_RENDER_DIRECT3D11_DEBUG = "SDL_RENDER_DIRECT3D11_DEBUG";
    const string SDL_HINT_RENDER_VULKAN_DEBUG = "SDL_RENDER_VULKAN_DEBUG";
    const string SDL_HINT_RENDER_GPU_DEBUG = "SDL_RENDER_GPU_DEBUG";
    const string SDL_HINT_RENDER_GPU_LOW_POWER = "SDL_RENDER_GPU_LOW_POWER";
    const string SDL_HINT_RENDER_DRIVER = "SDL_RENDER_DRIVER";
    const string SDL_HINT_RENDER_LINE_METHOD = "SDL_RENDER_LINE_METHOD";
    const string SDL_HINT_RENDER_METAL_PREFER_LOW_POWER_DEVICE = "SDL_RENDER_METAL_PREFER_LOW_POWER_DEVICE";
    const string SDL_HINT_RENDER_VSYNC = "SDL_RENDER_VSYNC";
    const string SDL_HINT_RETURN_KEY_HIDES_IME = "SDL_RETURN_KEY_HIDES_IME";
    const string SDL_HINT_ROG_GAMEPAD_MICE = "SDL_ROG_GAMEPAD_MICE";
    const string SDL_HINT_ROG_GAMEPAD_MICE_EXCLUDED = "SDL_ROG_GAMEPAD_MICE_EXCLUDED";
    const string SDL_HINT_RPI_VIDEO_LAYER = "SDL_RPI_VIDEO_LAYER";
    const string SDL_HINT_SCREENSAVER_INHIBIT_ACTIVITY_NAME = "SDL_SCREENSAVER_INHIBIT_ACTIVITY_NAME";
    const string SDL_HINT_SHUTDOWN_DBUS_ON_QUIT = "SDL_SHUTDOWN_DBUS_ON_QUIT";
    const string SDL_HINT_STORAGE_TITLE_DRIVER = "SDL_STORAGE_TITLE_DRIVER";
    const string SDL_HINT_STORAGE_USER_DRIVER = "SDL_STORAGE_USER_DRIVER";
    const string SDL_HINT_THREAD_FORCE_REALTIME_TIME_CRITICAL = "SDL_THREAD_FORCE_REALTIME_TIME_CRITICAL";
    ...
    const string SDL_HINT_TRACKPAD_IS_TOUCH_ONLY = "SDL_TRACKPAD_IS_TOUCH_ONLY";
    ...
    const string SDL_HINT_VIDEO_DRIVER = "SDL_VIDEO_DRIVER";
    const string SDL_HINT_VIDEO_DUMMY_SAVE_FRAMES = "SDL_VIDEO_DUMMY_SAVE_FRAMES";
    const string SDL_HINT_VIDEO_EGL_ALLOW_GETDISPLAY_FALLBACK = "SDL_VIDEO_EGL_ALLOW_GETDISPLAY_FALLBACK";
    const string SDL_HINT_VIDEO_FORCE_EGL = "SDL_VIDEO_FORCE_EGL";
    const string SDL_HINT_VIDEO_MAC_FULLSCREEN_SPACES = "SDL_VIDEO_MAC_FULLSCREEN_SPACES";
    const string SDL_HINT_VIDEO_MINIMIZE_ON_FOCUS_LOSS = "SDL_VIDEO_MINIMIZE_ON_FOCUS_LOSS";
    const string SDL_HINT_VIDEO_OFFSCREEN_SAVE_FRAMES = "SDL_VIDEO_OFFSCREEN_SAVE_FRAMES";
    const string SDL_HINT_VIDEO_SYNC_WINDOW_OPERATIONS = "SDL_VIDEO_SYNC_WINDOW_OPERATIONS";
    const string SDL_HINT_VIDEO_WAYLAND_ALLOW_LIBDECOR = "SDL_VIDEO_WAYLAND_ALLOW_LIBDECOR";
    const string SDL_HINT_VIDEO_WAYLAND_MODE_EMULATION = "SDL_VIDEO_WAYLAND_MODE_EMULATION";
    const string SDL_HINT_VIDEO_WAYLAND_MODE_SCALING = "SDL_VIDEO_WAYLAND_MODE_SCALING";
    const string SDL_HINT_VIDEO_WAYLAND_PREFER_LIBDECOR = "SDL_VIDEO_WAYLAND_PREFER_LIBDECOR";
    const string SDL_HINT_VIDEO_WAYLAND_SCALE_TO_DISPLAY = "SDL_VIDEO_WAYLAND_SCALE_TO_DISPLAY";
    const string SDL_HINT_VIDEO_WIN_D3DCOMPILER = "SDL_VIDEO_WIN_D3DCOMPILER";
    const string SDL_HINT_VIDEO_X11_NET_WM_BYPASS_COMPOSITOR = "SDL_VIDEO_X11_NET_WM_BYPASS_COMPOSITOR";
    const string SDL_HINT_VIDEO_X11_NET_WM_PING = "SDL_VIDEO_X11_NET_WM_PING";
    const string SDL_HINT_VIDEO_X11_NODIRECTCOLOR = "SDL_VIDEO_X11_NODIRECTCOLOR";
    const string SDL_HINT_VIDEO_X11_SCALING_FACTOR = "SDL_VIDEO_X11_SCALING_FACTOR";
    const string SDL_HINT_VIDEO_X11_VISUALID = "SDL_VIDEO_X11_VISUALID";
    const string SDL_HINT_VIDEO_X11_WINDOW_VISUALID = "SDL_VIDEO_X11_WINDOW_VISUALID";
    const string SDL_HINT_VIDEO_X11_XRANDR = "SDL_VIDEO_X11_XRANDR";
    const string SDL_HINT_VITA_ENABLE_BACK_TOUCH = "SDL_VITA_ENABLE_BACK_TOUCH";
    const string SDL_HINT_VITA_ENABLE_FRONT_TOUCH = "SDL_VITA_ENABLE_FRONT_TOUCH";
    const string SDL_HINT_VITA_MODULE_PATH = "SDL_VITA_MODULE_PATH";
    const string SDL_HINT_VITA_PVR_INIT = "SDL_VITA_PVR_INIT";
    const string SDL_HINT_VITA_RESOLUTION = "SDL_VITA_RESOLUTION";
    const string SDL_HINT_VITA_PVR_OPENGL = "SDL_VITA_PVR_OPENGL";
    const string SDL_HINT_VITA_TOUCH_MOUSE_DEVICE = "SDL_VITA_TOUCH_MOUSE_DEVICE";
    const string SDL_HINT_VULKAN_DISPLAY = "SDL_VULKAN_DISPLAY";
    const string SDL_HINT_VULKAN_LIBRARY = "SDL_VULKAN_LIBRARY";
    const string SDL_HINT_WAVE_FACT_CHUNK = "SDL_WAVE_FACT_CHUNK";
    const string SDL_HINT_WAVE_CHUNK_LIMIT = "SDL_WAVE_CHUNK_LIMIT";
    ...
    const string SDL_HINT_WINDOW_ACTIVATE_WHEN_RAISED = "SDL_WINDOW_ACTIVATE_WHEN_RAISED";
    const string SDL_HINT_WINDOW_ACTIVATE_WHEN_SHOWN = "SDL_WINDOW_ACTIVATE_WHEN_SHOWN";
    const string SDL_HINT_WINDOW_ALLOW_TOPMOST = "SDL_WINDOW_ALLOW_TOPMOST";
    const string SDL_HINT_WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN = "SDL_WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN";
    const string SDL_HINT_WINDOWS_CLOSE_ON_ALT_F4 = "SDL_WINDOWS_CLOSE_ON_ALT_F4";
    const string SDL_HINT_WINDOWS_ENABLE_MENU_MNEMONICS = "SDL_WINDOWS_ENABLE_MENU_MNEMONICS";
    const string SDL_HINT_WINDOWS_ENABLE_MESSAGELOOP = "SDL_WINDOWS_ENABLE_MESSAGELOOP";
    const string SDL_HINT_WINDOWS_GAMEINPUT = "SDL_WINDOWS_GAMEINPUT";
    const string SDL_HINT_WINDOWS_RAW_KEYBOARD = "SDL_WINDOWS_RAW_KEYBOARD";
    const string SDL_HINT_WINDOWS_FORCE_SEMAPHORE_KERNEL = "SDL_WINDOWS_FORCE_SEMAPHORE_KERNEL";
    const string SDL_HINT_WINDOWS_INTRESOURCE_ICON = "SDL_WINDOWS_INTRESOURCE_ICON";
    const string SDL_HINT_WINDOWS_INTRESOURCE_ICON_SMALL = "SDL_WINDOWS_INTRESOURCE_ICON_SMALL";
    const string SDL_HINT_WINDOWS_USE_D3D9EX = "SDL_WINDOWS_USE_D3D9EX";
    const string SDL_HINT_WINDOWS_ERASE_BACKGROUND_MODE = "SDL_WINDOWS_ERASE_BACKGROUND_MODE";
    const string SDL_HINT_X11_FORCE_OVERRIDE_REDIRECT = "SDL_X11_FORCE_OVERRIDE_REDIRECT";
    const string SDL_HINT_X11_WINDOW_TYPE = "SDL_X11_WINDOW_TYPE";
    const string SDL_HINT_X11_XCB_LIBRARY = "SDL_X11_XCB_LIBRARY";
    const string SDL_HINT_XINPUT_ENABLED = "SDL_XINPUT_ENABLED";
    const string SDL_HINT_ASSERT = "SDL_ASSERT";
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GetHint(ref char name); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_GetHintBoolean(ref char name, bool default_value); // WARN_UNKNOWN_POINTER_PARAMETER

    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate void SDL_HintCallback(IntPtr userdata, IntPtr name, IntPtr oldValue, IntPtr newValue);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_AddHintCallback(ref char name, /* SDL_HintCallback */ IntPtr callback, IntPtr userdata); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_RemoveHintCallback(ref char name, /* SDL_HintCallback */ IntPtr callback, IntPtr userdata); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetAppMetadata(ref char appname, ref char appversion, ref char appidentifier); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetAppMetadataProperty(ref char name, ref char value); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GetAppMetadataProperty(ref char name); // WARN_UNKNOWN_POINTER_PARAMETER

    // ../SDL3/SDL_loadso.h

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_LoadObject(ref char sofile); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_LoadFunction(IntPtr handle, ref char name); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_SetLogPriorityPrefix(SDL_LogPriority priority, ref char prefix); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_Log(ref char fmt); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_LogVerbose(int category, ref char fmt); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_LogDebug(int category, ref char fmt); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_LogInfo(int category, ref char fmt); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_LogWarn(int category, ref char fmt); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_LogError(int category, ref char fmt); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern void SDL_LogCritical(int category, ref char fmt); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_ShowSimpleMessageBox(uint flags, ref char title, ref char message, IntPtr window); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_OpenURL(ref char url); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_CreateWindowAndRenderer(ref char title, int width, int height, ulong window_flags, ref IntPtr window, ref IntPtr renderer); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_CreateRenderer(IntPtr window, ref char name); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_OpenTitleStorage(ref char @override, uint props); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_OpenUserStorage(ref char org, ref char app, uint props); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_OpenFileStorage(ref char path); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_GetStorageFileSize(IntPtr storage, ref char path, ref ulong length); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_ReadStorageFile(IntPtr storage, ref char path, IntPtr destination, ulong length); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_WriteStorageFile(IntPtr storage, ref char path, IntPtr source, ulong length); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_CreateStorageDirectory(IntPtr storage, ref char path); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_EnumerateStorageDirectory(IntPtr storage, ref char path, /* SDL_EnumerateDirectoryCallback */ IntPtr callback, IntPtr userdata); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_RemoveStoragePath(IntPtr storage, ref char path); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_RenameStoragePath(IntPtr storage, ref char oldpath, ref char newpath); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_CopyStorageFile(IntPtr storage, ref char oldpath, ref char newpath); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern bool SDL_GetStoragePathInfo(IntPtr storage, ref char path, ref SDL_PathInfo info); // WARN_UNKNOWN_POINTER_PARAMETER

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern ulong SDL_GetStorageSpaceRemaining(IntPtr storage);

    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_GlobStorageDirectory(IntPtr storage, ref char path, ref char pattern, uint flags, ref int count); // WARN_UNKNOWN_POINTER_PARAMETER
    ...
    [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr SDL_CreateThreadRuntime(/* SDL_ThreadFunction */ IntPtr fn, ref char name, IntPtr data, /* SDL_FunctionPointer */ IntPtr pfnBeginThread, /* SDL_FunctionPointer */ IntPtr pfnEndThread); // WARN_UNKNOWN_POINTER_PARAMETER
